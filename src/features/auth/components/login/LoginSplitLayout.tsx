...
/**
 * Split-panel responsivo da tela de login.
...
// Ruido estatico em data URI. Quebra banding 8-bit em tons escuros.
const NOISE_SVG =
...
// Mesh: base linear (verde escuro) + 2 radiais de luz dourada difusos e fracos.
...
export function LoginSplitLayout() {
  return (
    <main className="relative grid min-h-screen grid-cols-1 overflow-hidden lg:grid-cols-2">
      ...
      {/* Dither anti-banding sobre o mesh inteiro */}
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 z-0"
        style={{
